...
/** \mainpage RoboComp::roomLocalizationAgent
 *
 * \section intro_sec Introduction
 *
 * The roomLocalizationAgent component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/roomLocalizationAgent --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class roomLocalizationAgent : public RoboComp::Application
{
public:
	roomLocalizationAgent (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
void ::roomLocalizationAgent::initialize()
{
...
int ::roomLocalizationAgent::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::roomLocalizationAgent app(prefix, startup_check_flag);
