...
int ::viriatoDSR::run(int argc, char* argv[])
{
	...
	tprx = std::make_tuple(camerargbdsimple_proxy,camerasimple_proxy,coppeliautils_proxy,differentialrobot_proxy,fullposeestimation_proxy,jointmotorsimple_proxy,laser_proxy,laser1_proxy,omnirobot_proxy,realsensefaceid_proxy);
