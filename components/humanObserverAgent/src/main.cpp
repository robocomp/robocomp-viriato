...
/** \mainpage RoboComp::humanObserverAgent
 *
 * \section intro_sec Introduction
 *
 * The humanObserverAgent component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/humanObserverAgent --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class humanObserverAgent : public RoboComp::Application
{
public:
	humanObserverAgent (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
void ::humanObserverAgent::initialize()
{
...
int main(int argc, char* argv[])
{
	...
	::humanObserverAgent app(prefix, startup_check_flag);
