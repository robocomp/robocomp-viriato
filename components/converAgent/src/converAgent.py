...
#
# Just: "${PATH_TO_BINARY}/converAgent --Ice.Config=${PATH_TO_CONFIG_FILE}"
#
...
if __name__ == '__main__':
    ...
    try:
        ...
        try:
            basePrx = ic.stringToProxy(proxyString)
            innermodelmanager_proxy = RoboCompInnerModelManager.InnerModelManagerPrx.uncheckedCast(basePrx)
