...
using AttributeMap = ::std::map<::std::string, ::RoboCompInnerModelManager::AttributeType>;
...
using NodeInformationSequence = ::std::vector<::RoboCompInnerModelManager::NodeInformation>;
...
public:
    ...
    InnerModelManagerError(::RoboCompInnerModelManager::ErrorType iceP_err, const ::std::string& iceP_text) :
        err(iceP_err),
        text(::std::move(iceP_text))
    {
    }
...
using PointCloudVector = ::std::vector<::RoboCompInnerModelManager::Colored3DPoint>;
...
public:
    ...
    virtual bool addMesh(::std::string, ::std::string, ::RoboCompInnerModelManager::meshType, const ::Ice::Current&) = 0;
    ...
    virtual bool getPose(::std::string, ::std::string, ::RoboCompInnerModelManager::Pose3D&, const ::Ice::Current&) = 0;
...
public:
    ...
    {
        return _makePromiseOutgoing<bool>(true, this, &RoboCompInnerModelManager::InnerModelManagerPrx::_iceI_addJoint, iceP_item, iceP_base, iceP_j, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto addJointAsync(const ::std::string& iceP_item, const ::std::string& iceP_base, const ::RoboCompInnerModelManager::jointType& iceP_j, const ::Ice::Context& context = Ice::noExplicitContext)
        -> decltype(::std::declval<P<bool>>().get_future())
    {
        return _makePromiseOutgoing<bool, P>(false, this, &RoboCompInnerModelManager::InnerModelManagerPrx::_iceI_addJoint, iceP_item, iceP_base, iceP_j, context);
    }

    ::std::function<void()>
    addJointAsync(const ::std::string& iceP_item, const ::std::string& iceP_base, const ::RoboCompInnerModelManager::jointType& iceP_j,
                  ::std::function<void(bool)> response,
                  ::std::function<void(::std::exception_ptr)> ex = nullptr,
                  ::std::function<void(bool)> sent = nullptr,
                  const ::Ice::Context& context = Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<bool>(response, ex, sent, this, &RoboCompInnerModelManager::InnerModelManagerPrx::_iceI_addJoint, iceP_item, iceP_base, iceP_j, context);
    }

    void _iceI_addJoint(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<bool>>&, const ::std::string&, const ::std::string&, const ::RoboCompInnerModelManager::jointType&, const ::Ice::Context&);

    bool addMesh(const ::std::string& iceP_item, const ::std::string& iceP_base, const ::RoboCompInnerModelManager::meshType& iceP_m, const ::Ice::Context& context = Ice::noExplicitContext)
    {
        return _makePromiseOutgoing<bool>(true, this, &RoboCompInnerModelManager::InnerModelManagerPrx::_iceI_addMesh, iceP_item, iceP_base, iceP_m, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto addMeshAsync(const ::std::string& iceP_item, const ::std::string& iceP_base, const ::RoboCompInnerModelManager::meshType& iceP_m, const ::Ice::Context& context = Ice::noExplicitContext)
        -> decltype(::std::declval<P<bool>>().get_future())
    {
        return _makePromiseOutgoing<bool, P>(false, this, &RoboCompInnerModelManager::InnerModelManagerPrx::_iceI_addMesh, iceP_item, iceP_base, iceP_m, context);
    }

    ::std::function<void()>
    addMeshAsync(const ::std::string& iceP_item, const ::std::string& iceP_base, const ::RoboCompInnerModelManager::meshType& iceP_m,
                 ::std::function<void(bool)> response,
                 ::std::function<void(::std::exception_ptr)> ex = nullptr,
                 ::std::function<void(bool)> sent = nullptr,
                 const ::Ice::Context& context = Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<bool>(response, ex, sent, this, &RoboCompInnerModelManager::InnerModelManagerPrx::_iceI_addMesh, iceP_item, iceP_base, iceP_m, context);
    }

    void _iceI_addMesh(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<bool>>&, const ::std::string&, const ::std::string&, const ::RoboCompInnerModelManager::meshType&, const ::Ice::Context&);

    bool addPlane(const ::std::string& iceP_item, const ::std::string& iceP_base, const ::RoboCompInnerModelManager::Plane3D& iceP_plane, const ::Ice::Context& context = Ice::noExplicitContext)
    {
        return _makePromiseOutgoing<bool>(true, this, &RoboCompInnerModelManager::InnerModelManagerPrx::_iceI_addPlane, iceP_item, iceP_base, iceP_plane, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto addPlaneAsync(const ::std::string& iceP_item, const ::std::string& iceP_base, const ::RoboCompInnerModelManager::Plane3D& iceP_plane, const ::Ice::Context& context = Ice::noExplicitContext)
        -> decltype(::std::declval<P<bool>>().get_future())
    {
        return _makePromiseOutgoing<bool, P>(false, this, &RoboCompInnerModelManager::InnerModelManagerPrx::_iceI_addPlane, iceP_item, iceP_base, iceP_plane, context);
    }

    ::std::function<void()>
    addPlaneAsync(const ::std::string& iceP_item, const ::std::string& iceP_base, const ::RoboCompInnerModelManager::Plane3D& iceP_plane,
                  ::std::function<void(bool)> response,
                  ::std::function<void(::std::exception_ptr)> ex = nullptr,
                  ::std::function<void(bool)> sent = nullptr,
                  const ::Ice::Context& context = Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<bool>(response, ex, sent, this, &RoboCompInnerModelManager::InnerModelManagerPrx::_iceI_addPlane, iceP_item, iceP_base, iceP_plane, context);
    }
    ...
    {
        return _makePromiseOutgoing<::RoboCompInnerModelManager::NodeInformationSequence, P>(false, this, &RoboCompInnerModelManager::InnerModelManagerPrx::_iceI_getAllNodeInformation, context);
    }
    ...
    {
        auto result = _makePromiseOutgoing<::RoboCompInnerModelManager::InnerModelManager::GetPoseResult>(true, this, &RoboCompInnerModelManager::InnerModelManagerPrx::_iceI_getPose, iceP_base, iceP_item, context).get();
        iceP_pose = ::std::move(result.pose);
        return result.returnValue;
    }

    template<template<typename> class P = ::std::promise>
    auto getPoseAsync(const ::std::string& iceP_base, const ::std::string& iceP_item, const ::Ice::Context& context = Ice::noExplicitContext)
        -> decltype(::std::declval<P<::RoboCompInnerModelManager::InnerModelManager::GetPoseResult>>().get_future())
    {
        return _makePromiseOutgoing<::RoboCompInnerModelManager::InnerModelManager::GetPoseResult, P>(false, this, &RoboCompInnerModelManager::InnerModelManagerPrx::_iceI_getPose, iceP_base, iceP_item, context);
    }

    ::std::function<void()>
    getPoseAsync(const ::std::string& iceP_base, const ::std::string& iceP_item,
                 ::std::function<void(bool, ::RoboCompInnerModelManager::Pose3D)> response,
                 ::std::function<void(::std::exception_ptr)> ex = nullptr,
                 ::std::function<void(bool)> sent = nullptr,
                 const ::Ice::Context& context = Ice::noExplicitContext)
    {
        auto responseCb = [response](::RoboCompInnerModelManager::InnerModelManager::GetPoseResult&& result)
        {
            response(result.returnValue, ::std::move(result.pose));
        };
        return _makeLamdaOutgoing<::RoboCompInnerModelManager::InnerModelManager::GetPoseResult>(responseCb, ex, sent, this, &RoboCompInnerModelManager::InnerModelManagerPrx::_iceI_getPose, iceP_base, iceP_item, context);
    }

    void _iceI_getPose(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::RoboCompInnerModelManager::InnerModelManager::GetPoseResult>>&, const ::std::string&, const ::std::string&, const ::Ice::Context&);

    bool getPoseFromParent(const ::std::string& iceP_item, ::RoboCompInnerModelManager::Pose3D& iceP_pose, const ::Ice::Context& context = Ice::noExplicitContext)
    {
        auto result = _makePromiseOutgoing<::RoboCompInnerModelManager::InnerModelManager::GetPoseFromParentResult>(true, this, &RoboCompInnerModelManager::InnerModelManagerPrx::_iceI_getPoseFromParent, iceP_item, context).get();
        iceP_pose = ::std::move(result.pose);
        return result.returnValue;
    }

    template<template<typename> class P = ::std::promise>
    auto getPoseFromParentAsync(const ::std::string& iceP_item, const ::Ice::Context& context = Ice::noExplicitContext)
        -> decltype(::std::declval<P<::RoboCompInnerModelManager::InnerModelManager::GetPoseFromParentResult>>().get_future())
    {
        return _makePromiseOutgoing<::RoboCompInnerModelManager::InnerModelManager::GetPoseFromParentResult, P>(false, this, &RoboCompInnerModelManager::InnerModelManagerPrx::_iceI_getPoseFromParent, iceP_item, context);
    }

    ::std::function<void()>
    getPoseFromParentAsync(const ::std::string& iceP_item,
                           ::std::function<void(bool, ::RoboCompInnerModelManager::Pose3D)> response,
                           ::std::function<void(::std::exception_ptr)> ex = nullptr,
                           ::std::function<void(bool)> sent = nullptr,
                           const ::Ice::Context& context = Ice::noExplicitContext)
    {
        auto responseCb = [response](::RoboCompInnerModelManager::InnerModelManager::GetPoseFromParentResult&& result)
        {
            response(result.returnValue, ::std::move(result.pose));
        };
        return _makeLamdaOutgoing<::RoboCompInnerModelManager::InnerModelManager::GetPoseFromParentResult>(responseCb, ex, sent, this, &RoboCompInnerModelManager::InnerModelManagerPrx::_iceI_getPoseFromParent, iceP_item, context);
    }
    ...
    template<template<typename> class P = ::std::promise>
    auto setPlaneAsync(const ::std::string& iceP_item, const ::RoboCompInnerModelManager::Plane3D& iceP_plane, const ::Ice::Context& context = Ice::noExplicitContext)
        -> decltype(::std::declval<P<bool>>().get_future())
    {
        return _makePromiseOutgoing<bool, P>(false, this, &RoboCompInnerModelManager::InnerModelManagerPrx::_iceI_setPlane, iceP_item, iceP_plane, context);
    }

    ::std::function<void()>
    setPlaneAsync(const ::std::string& iceP_item, const ::RoboCompInnerModelManager::Plane3D& iceP_plane,
                  ::std::function<void(bool)> response,
                  ::std::function<void(::std::exception_ptr)> ex = nullptr,
                  ::std::function<void(bool)> sent = nullptr,
                  const ::Ice::Context& context = Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<bool>(response, ex, sent, this, &RoboCompInnerModelManager::InnerModelManagerPrx::_iceI_setPlane, iceP_item, iceP_plane, context);
    }
    ...
    {
        auto result = _makePromiseOutgoing<::RoboCompInnerModelManager::InnerModelManager::TransformResult>(true, this, &RoboCompInnerModelManager::InnerModelManagerPrx::_iceI_transform, iceP_base, iceP_item, iceP_coordInItem, context).get();
        iceP_coordInBase = ::std::move(result.coordInBase);
        return result.returnValue;
    }

    template<template<typename> class P = ::std::promise>
    auto transformAsync(const ::std::string& iceP_base, const ::std::string& iceP_item, const ::RoboCompInnerModelManager::coord3D& iceP_coordInItem, const ::Ice::Context& context = Ice::noExplicitContext)
        -> decltype(::std::declval<P<::RoboCompInnerModelManager::InnerModelManager::TransformResult>>().get_future())
    {
        return _makePromiseOutgoing<::RoboCompInnerModelManager::InnerModelManager::TransformResult, P>(false, this, &RoboCompInnerModelManager::InnerModelManagerPrx::_iceI_transform, iceP_base, iceP_item, iceP_coordInItem, context);
    }

    ::std::function<void()>
    transformAsync(const ::std::string& iceP_base, const ::std::string& iceP_item, const ::RoboCompInnerModelManager::coord3D& iceP_coordInItem,
                   ::std::function<void(bool, ::RoboCompInnerModelManager::coord3D)> response,
                   ::std::function<void(::std::exception_ptr)> ex = nullptr,
                   ::std::function<void(bool)> sent = nullptr,
                   const ::Ice::Context& context = Ice::noExplicitContext)
    {
        auto responseCb = [response](::RoboCompInnerModelManager::InnerModelManager::TransformResult&& result)
        {
            response(result.returnValue, ::std::move(result.coordInBase));
        };
        return _makeLamdaOutgoing<::RoboCompInnerModelManager::InnerModelManager::TransformResult>(responseCb, ex, sent, this, &RoboCompInnerModelManager::InnerModelManagerPrx::_iceI_transform, iceP_base, iceP_item, iceP_coordInItem, context);
    }
...
class InnerModelManager;
void _readProxy(::Ice::InputStream*, ::IceInternal::ProxyHandle< ::IceProxy::RoboCompInnerModelManager::InnerModelManager>&);
...
public:
    ...
    bool addJoint(const ::std::string& iceP_item, const ::std::string& iceP_base, const ::RoboCompInnerModelManager::jointType& iceP_j, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return end_addJoint(_iceI_begin_addJoint(iceP_item, iceP_base, iceP_j, context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_addJoint(const ::std::string& iceP_item, const ::std::string& iceP_base, const ::RoboCompInnerModelManager::jointType& iceP_j, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_addJoint(iceP_item, iceP_base, iceP_j, context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_addJoint(const ::std::string& iceP_item, const ::std::string& iceP_base, const ::RoboCompInnerModelManager::jointType& iceP_j, const ::Ice::CallbackPtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_addJoint(iceP_item, iceP_base, iceP_j, ::Ice::noExplicitContext, del, cookie);
    }

    ::Ice::AsyncResultPtr begin_addJoint(const ::std::string& iceP_item, const ::std::string& iceP_base, const ::RoboCompInnerModelManager::jointType& iceP_j, const ::Ice::Context& context, const ::Ice::CallbackPtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_addJoint(iceP_item, iceP_base, iceP_j, context, del, cookie);
    }

    ::Ice::AsyncResultPtr begin_addJoint(const ::std::string& iceP_item, const ::std::string& iceP_base, const ::RoboCompInnerModelManager::jointType& iceP_j, const ::RoboCompInnerModelManager::Callback_InnerModelManager_addJointPtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_addJoint(iceP_item, iceP_base, iceP_j, ::Ice::noExplicitContext, del, cookie);
    }

    ::Ice::AsyncResultPtr begin_addJoint(const ::std::string& iceP_item, const ::std::string& iceP_base, const ::RoboCompInnerModelManager::jointType& iceP_j, const ::Ice::Context& context, const ::RoboCompInnerModelManager::Callback_InnerModelManager_addJointPtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_addJoint(iceP_item, iceP_base, iceP_j, context, del, cookie);
    }
...
public:
    ...
    bool addMesh(const ::std::string& iceP_item, const ::std::string& iceP_base, const ::RoboCompInnerModelManager::meshType& iceP_m, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return end_addMesh(_iceI_begin_addMesh(iceP_item, iceP_base, iceP_m, context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_addMesh(const ::std::string& iceP_item, const ::std::string& iceP_base, const ::RoboCompInnerModelManager::meshType& iceP_m, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_addMesh(iceP_item, iceP_base, iceP_m, context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_addMesh(const ::std::string& iceP_item, const ::std::string& iceP_base, const ::RoboCompInnerModelManager::meshType& iceP_m, const ::Ice::CallbackPtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_addMesh(iceP_item, iceP_base, iceP_m, ::Ice::noExplicitContext, del, cookie);
    }

    ::Ice::AsyncResultPtr begin_addMesh(const ::std::string& iceP_item, const ::std::string& iceP_base, const ::RoboCompInnerModelManager::meshType& iceP_m, const ::Ice::Context& context, const ::Ice::CallbackPtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_addMesh(iceP_item, iceP_base, iceP_m, context, del, cookie);
    }

    ::Ice::AsyncResultPtr begin_addMesh(const ::std::string& iceP_item, const ::std::string& iceP_base, const ::RoboCompInnerModelManager::meshType& iceP_m, const ::RoboCompInnerModelManager::Callback_InnerModelManager_addMeshPtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_addMesh(iceP_item, iceP_base, iceP_m, ::Ice::noExplicitContext, del, cookie);
    }

    ::Ice::AsyncResultPtr begin_addMesh(const ::std::string& iceP_item, const ::std::string& iceP_base, const ::RoboCompInnerModelManager::meshType& iceP_m, const ::Ice::Context& context, const ::RoboCompInnerModelManager::Callback_InnerModelManager_addMeshPtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_addMesh(iceP_item, iceP_base, iceP_m, context, del, cookie);
    }
...
public:
    ...
    bool addPlane(const ::std::string& iceP_item, const ::std::string& iceP_base, const ::RoboCompInnerModelManager::Plane3D& iceP_plane, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return end_addPlane(_iceI_begin_addPlane(iceP_item, iceP_base, iceP_plane, context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_addPlane(const ::std::string& iceP_item, const ::std::string& iceP_base, const ::RoboCompInnerModelManager::Plane3D& iceP_plane, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_addPlane(iceP_item, iceP_base, iceP_plane, context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_addPlane(const ::std::string& iceP_item, const ::std::string& iceP_base, const ::RoboCompInnerModelManager::Plane3D& iceP_plane, const ::Ice::CallbackPtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_addPlane(iceP_item, iceP_base, iceP_plane, ::Ice::noExplicitContext, del, cookie);
    }

    ::Ice::AsyncResultPtr begin_addPlane(const ::std::string& iceP_item, const ::std::string& iceP_base, const ::RoboCompInnerModelManager::Plane3D& iceP_plane, const ::Ice::Context& context, const ::Ice::CallbackPtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_addPlane(iceP_item, iceP_base, iceP_plane, context, del, cookie);
    }

    ::Ice::AsyncResultPtr begin_addPlane(const ::std::string& iceP_item, const ::std::string& iceP_base, const ::RoboCompInnerModelManager::Plane3D& iceP_plane, const ::RoboCompInnerModelManager::Callback_InnerModelManager_addPlanePtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_addPlane(iceP_item, iceP_base, iceP_plane, ::Ice::noExplicitContext, del, cookie);
    }

    ::Ice::AsyncResultPtr begin_addPlane(const ::std::string& iceP_item, const ::std::string& iceP_base, const ::RoboCompInnerModelManager::Plane3D& iceP_plane, const ::Ice::Context& context, const ::RoboCompInnerModelManager::Callback_InnerModelManager_addPlanePtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_addPlane(iceP_item, iceP_base, iceP_plane, context, del, cookie);
    }
...
public:
    ...
    ::Ice::AsyncResultPtr begin_getAllNodeInformation(const ::Ice::CallbackPtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getAllNodeInformation(::Ice::noExplicitContext, del, cookie);
    }

    ::Ice::AsyncResultPtr begin_getAllNodeInformation(const ::Ice::Context& context, const ::Ice::CallbackPtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getAllNodeInformation(context, del, cookie);
    }

    ::Ice::AsyncResultPtr begin_getAllNodeInformation(const ::RoboCompInnerModelManager::Callback_InnerModelManager_getAllNodeInformationPtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getAllNodeInformation(::Ice::noExplicitContext, del, cookie);
    }

    ::Ice::AsyncResultPtr begin_getAllNodeInformation(const ::Ice::Context& context, const ::RoboCompInnerModelManager::Callback_InnerModelManager_getAllNodeInformationPtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getAllNodeInformation(context, del, cookie);
    }

    void end_getAllNodeInformation(::RoboCompInnerModelManager::NodeInformationSequence& iceP_nodesInfo, const ::Ice::AsyncResultPtr&);
...
public:
    ...
    bool getPose(const ::std::string& iceP_base, const ::std::string& iceP_item, ::RoboCompInnerModelManager::Pose3D& iceP_pose, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return end_getPose(iceP_pose, _iceI_begin_getPose(iceP_base, iceP_item, context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_getPose(const ::std::string& iceP_base, const ::std::string& iceP_item, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_getPose(iceP_base, iceP_item, context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_getPose(const ::std::string& iceP_base, const ::std::string& iceP_item, const ::Ice::CallbackPtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getPose(iceP_base, iceP_item, ::Ice::noExplicitContext, del, cookie);
    }

    ::Ice::AsyncResultPtr begin_getPose(const ::std::string& iceP_base, const ::std::string& iceP_item, const ::Ice::Context& context, const ::Ice::CallbackPtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getPose(iceP_base, iceP_item, context, del, cookie);
    }

    ::Ice::AsyncResultPtr begin_getPose(const ::std::string& iceP_base, const ::std::string& iceP_item, const ::RoboCompInnerModelManager::Callback_InnerModelManager_getPosePtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getPose(iceP_base, iceP_item, ::Ice::noExplicitContext, del, cookie);
    }

    ::Ice::AsyncResultPtr begin_getPose(const ::std::string& iceP_base, const ::std::string& iceP_item, const ::Ice::Context& context, const ::RoboCompInnerModelManager::Callback_InnerModelManager_getPosePtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getPose(iceP_base, iceP_item, context, del, cookie);
    }

    bool end_getPose(::RoboCompInnerModelManager::Pose3D& iceP_pose, const ::Ice::AsyncResultPtr&);
...
public:
    ...
    bool getPoseFromParent(const ::std::string& iceP_item, ::RoboCompInnerModelManager::Pose3D& iceP_pose, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return end_getPoseFromParent(iceP_pose, _iceI_begin_getPoseFromParent(iceP_item, context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_getPoseFromParent(const ::std::string& iceP_item, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_getPoseFromParent(iceP_item, context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_getPoseFromParent(const ::std::string& iceP_item, const ::Ice::CallbackPtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getPoseFromParent(iceP_item, ::Ice::noExplicitContext, del, cookie);
    }

    ::Ice::AsyncResultPtr begin_getPoseFromParent(const ::std::string& iceP_item, const ::Ice::Context& context, const ::Ice::CallbackPtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getPoseFromParent(iceP_item, context, del, cookie);
    }

    ::Ice::AsyncResultPtr begin_getPoseFromParent(const ::std::string& iceP_item, const ::RoboCompInnerModelManager::Callback_InnerModelManager_getPoseFromParentPtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getPoseFromParent(iceP_item, ::Ice::noExplicitContext, del, cookie);
    }

    ::Ice::AsyncResultPtr begin_getPoseFromParent(const ::std::string& iceP_item, const ::Ice::Context& context, const ::RoboCompInnerModelManager::Callback_InnerModelManager_getPoseFromParentPtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getPoseFromParent(iceP_item, context, del, cookie);
    }

    bool end_getPoseFromParent(::RoboCompInnerModelManager::Pose3D& iceP_pose, const ::Ice::AsyncResultPtr&);
...
public:
    ...
    ::Ice::AsyncResultPtr begin_getTransformationMatrix(const ::std::string& iceP_base, const ::std::string& iceP_item, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_getTransformationMatrix(iceP_base, iceP_item, context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_getTransformationMatrix(const ::std::string& iceP_base, const ::std::string& iceP_item, const ::Ice::CallbackPtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getTransformationMatrix(iceP_base, iceP_item, ::Ice::noExplicitContext, del, cookie);
    }

    ::Ice::AsyncResultPtr begin_getTransformationMatrix(const ::std::string& iceP_base, const ::std::string& iceP_item, const ::Ice::Context& context, const ::Ice::CallbackPtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getTransformationMatrix(iceP_base, iceP_item, context, del, cookie);
    }

    ::Ice::AsyncResultPtr begin_getTransformationMatrix(const ::std::string& iceP_base, const ::std::string& iceP_item, const ::RoboCompInnerModelManager::Callback_InnerModelManager_getTransformationMatrixPtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getTransformationMatrix(iceP_base, iceP_item, ::Ice::noExplicitContext, del, cookie);
    }

    ::Ice::AsyncResultPtr begin_getTransformationMatrix(const ::std::string& iceP_base, const ::std::string& iceP_item, const ::Ice::Context& context, const ::RoboCompInnerModelManager::Callback_InnerModelManager_getTransformationMatrixPtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getTransformationMatrix(iceP_base, iceP_item, context, del, cookie);
    }
...
public:
    ...
    bool moveNode(const ::std::string& iceP_src, const ::std::string& iceP_dst, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return end_moveNode(_iceI_begin_moveNode(iceP_src, iceP_dst, context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_moveNode(const ::std::string& iceP_src, const ::std::string& iceP_dst, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_moveNode(iceP_src, iceP_dst, context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_moveNode(const ::std::string& iceP_src, const ::std::string& iceP_dst, const ::Ice::CallbackPtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_moveNode(iceP_src, iceP_dst, ::Ice::noExplicitContext, del, cookie);
    }

    ::Ice::AsyncResultPtr begin_moveNode(const ::std::string& iceP_src, const ::std::string& iceP_dst, const ::Ice::Context& context, const ::Ice::CallbackPtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_moveNode(iceP_src, iceP_dst, context, del, cookie);
    }

    ::Ice::AsyncResultPtr begin_moveNode(const ::std::string& iceP_src, const ::std::string& iceP_dst, const ::RoboCompInnerModelManager::Callback_InnerModelManager_moveNodePtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_moveNode(iceP_src, iceP_dst, ::Ice::noExplicitContext, del, cookie);
    }

    ::Ice::AsyncResultPtr begin_moveNode(const ::std::string& iceP_src, const ::std::string& iceP_dst, const ::Ice::Context& context, const ::RoboCompInnerModelManager::Callback_InnerModelManager_moveNodePtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_moveNode(iceP_src, iceP_dst, context, del, cookie);
    }
...
public:
    ...
    void setPointCloudData(const ::std::string& iceP_id, const ::RoboCompInnerModelManager::PointCloudVector& iceP_cloud, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        end_setPointCloudData(_iceI_begin_setPointCloudData(iceP_id, iceP_cloud, context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_setPointCloudData(const ::std::string& iceP_id, const ::RoboCompInnerModelManager::PointCloudVector& iceP_cloud, const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_setPointCloudData(iceP_id, iceP_cloud, context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_setPointCloudData(const ::std::string& iceP_id, const ::RoboCompInnerModelManager::PointCloudVector& iceP_cloud, const ::Ice::CallbackPtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_setPointCloudData(iceP_id, iceP_cloud, ::Ice::noExplicitContext, del, cookie);
    }

    ::Ice::AsyncResultPtr begin_setPointCloudData(const ::std::string& iceP_id, const ::RoboCompInnerModelManager::PointCloudVector& iceP_cloud, const ::Ice::Context& context, const ::Ice::CallbackPtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_setPointCloudData(iceP_id, iceP_cloud, context, del, cookie);
    }

    ::Ice::AsyncResultPtr begin_setPointCloudData(const ::std::string& iceP_id, const ::RoboCompInnerModelManager::PointCloudVector& iceP_cloud, const ::RoboCompInnerModelManager::Callback_InnerModelManager_setPointCloudDataPtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_setPointCloudData(iceP_id, iceP_cloud, ::Ice::noExplicitContext, del, cookie);
    }

    ::Ice::AsyncResultPtr begin_setPointCloudData(const ::std::string& iceP_id, const ::RoboCompInnerModelManager::PointCloudVector& iceP_cloud, const ::Ice::Context& context, const ::RoboCompInnerModelManager::Callback_InnerModelManager_setPointCloudDataPtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_setPointCloudData(iceP_id, iceP_cloud, context, del, cookie);
    }
...
public:
    ...
    virtual bool addMesh(const ::std::string&, const ::std::string&, const ::RoboCompInnerModelManager::meshType&, const ::Ice::Current& = ::Ice::emptyCurrent) = 0;
    bool _iceD_addMesh(::IceInternal::Incoming&, const ::Ice::Current&);
