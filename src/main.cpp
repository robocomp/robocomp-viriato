...
/** \mainpage RoboComp::HumanSceneSim
 *
 * \section intro_sec Introduction
 *
 * The HumanSceneSim component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/HumanSceneSim --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class HumanSceneSim : public RoboComp::Application
{
public:
	HumanSceneSim (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::HumanSceneSim::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
