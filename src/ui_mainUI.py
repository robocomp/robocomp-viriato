...
class Ui_guiDlg(object):
    def setupUi(self, guiDlg):
        ...
        self.dateTimeEdit = QDateTimeEdit(guiDlg)
        self.dateTimeEdit.setObjectName(u"dateTimeEdit")
        self.dateTimeEdit.setGeometry(QRect(40, 30, 151, 26))
        ...
        self.pushButton_14.setGeometry(QRect(210, 30, 101, 23))
        self.line_5 = QFrame(guiDlg)
        self.line_5.setObjectName(u"line_5")
        self.line_5.setGeometry(QRect(310, 0, 20, 91))
        self.line_5.setFrameShape(QFrame.VLine)
        self.line_5.setFrameShadow(QFrame.Sunken)
        self.label_24 = QLabel(guiDlg)
        self.label_24.setObjectName(u"label_24")
        self.label_24.setGeometry(QRect(370, 0, 151, 21))
        self.pushButton_10 = QPushButton(guiDlg)
        self.pushButton_10.setObjectName(u"pushButton_10")
        self.pushButton_10.setGeometry(QRect(330, 60, 91, 23))
        self.pushButton_11 = QPushButton(guiDlg)
        self.pushButton_11.setObjectName(u"pushButton_11")
        self.pushButton_11.setGeometry(QRect(430, 60, 91, 23))
        self.comboBox_3 = QComboBox(guiDlg)
        self.comboBox_3.setObjectName(u"comboBox_3")
        self.comboBox_3.setGeometry(QRect(330, 30, 191, 22))
